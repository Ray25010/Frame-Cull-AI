...
- 统计日期：`2026-07-19`
- 采集时间：`2026-07-19T03:58:38.462Z`
- 当前资产累计下载次数：**25**
- 本次记录新增下载次数：**3**

| Release tag | 资产 | 累计下载 | 本次新增 | 状态 |
| --- | --- | ---: | ---: | --- |
| macos-test-0.1.6-run-29097861619 | FrameCull-macOS-arm64.zip | 17 | +1 | existing |
| macos-test-0.1.6-run-29097861619 | FrameCull-macOS-x64.zip | 2 | +0 | existing |
| v0.1.6-beta.2 | FrameCull.AI.Flash_0.1.6-beta.2_x64-setup.exe | 3 | +2 | existing |
