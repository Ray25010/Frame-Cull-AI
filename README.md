...
- 统计日期：`2026-07-17`
- 采集时间：`2026-07-17T03:41:17.048Z`
- 当前资产累计下载次数：**22**
- 本次记录新增下载次数：**1**

| Release tag | 资产 | 累计下载 | 本次新增 | 状态 |
| --- | --- | ---: | ---: | --- |
| macos-test-0.1.6-run-29097861619 | FrameCull-macOS-arm64.zip | 16 | +0 | existing |
...
| v0.1.6-beta.2 | FrameCull.AI.Pro_0.1.6-beta.2_x64-setup.exe | 3 | +1 | existing |
